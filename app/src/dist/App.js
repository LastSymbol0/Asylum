...
function App() {
    return (React.createElement(core_1.ThemeProvider, { theme: theme },
        ...
        React.createElement("div", { className: "App" },
            React.createElement(react_router_dom_1.HashRouter, { basename: process.env.PUBLIC_URL ? "" + process.env.PUBLIC_URL : undefined },
                React.createElement(material_1.Grid, { container: true, columns: 1 },
